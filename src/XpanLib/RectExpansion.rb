...
#==============================================================================#
#-end:
#-inject gen_scr_imported_ww 'RectExpansion', '0x10000'
#-inject gen_func_header 'Rect.center'
def Rect.center(r1,r2)
  Rect.new(r1.x+(r1.width-r2.width)/2,r1.y+(r1.height-r2.height)/2,r2.width,r2.height) 
end
#-inject gen_func_header 'Rect.fit_in'
...
#-inject gen_module_header 'MACL::Mixin::RectExpansion'
...
#-inject gen_mdoule_header 'RectOnly'
  module RectOnly
