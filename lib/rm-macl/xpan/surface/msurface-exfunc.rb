#
# rm-macl/lib/rm-macl/xpan/surface/msurface-exfunc.rb
#   by IceDragon
#   dc ??/??/2012
#   dc 11/05/2013
# vr 1.4.1
...
module MACL
  module Mixin
    module Surface
      ...
      def surface3?
        self.kind_of?(MACL::Mixin::Surface3)
      end
      ...
      define_exfunc 'reanchor' do |*args|
        ...
        set_anchor_z(az, nz) if nz if surface3?
...
MACL.register('macl/xpan/surface/msurface-exfunc', '1.5.0')