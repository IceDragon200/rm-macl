#
# rm-macl/lib/rm-macl/xpan/morph.rb
#
...
module MACL
  module Morph
    ...
    MACL.register('macl/xpan/morph/growth', '1.1.0')
    ...
    class Devour
      ...
      def devour
        new_nodes = @growth.grow.open_nodes.map { |nd| [nd[0]+@x, nd[1]+@y] }
    ...
    MACL.register('macl/xpan/morph/devour', '1.1.0')
    ...
    MACL.register('macl/xpan/morph/decimate', '1.1.0')
  end
end
MACL.register('macl/xpan/morph', '1.1.0')