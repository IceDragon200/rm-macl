#
# rm-macl/lib/rm-macl/util/note_reader.rb
#   by IceDragon
require 'rm-macl/macl-core' unless defined?(MACL::EMBEDDED)
module MACL #:nodoc:
  class NoteReader
...
MACL.register('macl/util/note_reader', '1.1.0') if defined?(MACL.register)